...
ready = function() {
    ...
    function spinner_nav(){
        var exists =(jQuery('<div class="quantity-nav"><div class="quantity-button quantity-up">+</div><div class="quantity-button quantity-down">-</div></div>')
    ...
    function spinner() {
        ...
        jQuery('.quantity').each(function () {
            ...
            btnUp.unbind('click').click(function () {
                ...
                console.log(step);
                spinner.find("input").val(roundToOne(newVal));
...
function confirm(title, message, callback) {
    var modal = '<div class="reveal tiny" id="confirmation">'+
        ...
        '<button class="button primary yes">'+ I18n["defaults"]["misc"]["y"] +'</button>'+
        '<button class="button secondary float-right" data-close>'+ I18n["defaults"]["misc"]["n"] +'</button>'+
        '</div>';
    $('body').append(modal);
